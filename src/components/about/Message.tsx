                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-20 items-stretch relative">
                    ...
                    <div className="lg:col-span-5 lg:sticky lg:top-28 lg:h-fit space-y-6 md:space-y-8 text-center lg:text-right z-20 pb-6 lg:pb-0 flex flex-col items-center lg:items-start">
                        <div className="space-y-2 w-full">
                            ...
                            <h2 className="text-white text-3xl sm:text-5xl lg:text-6xl font-black tracking-tighter leading-tight">
                                ...
                                <span className="text-transparent bg-clip-text bg-gradient-to-l from-blue-400 to-blue-600"> في نجاحك.</span>
                            </h2>
                        </div>

                        {/* تم تعديل الحواف (border) والـ padding لتتناسب مع التوسيط على الموبايل */}
                        <p className="text-slate-200 text-base md:text-xl leading-relaxed font-light italic border-b-4 lg:border-b-0 lg:border-r-4 border-blue-600 pb-4 lg:pb-0 lg:pr-4">
                    ...
                    <div className="lg:col-span-7 space-y-6 md:space-y-8 relative before:absolute before:hidden lg:before:block before:right-1/2 lg:before:right-4 before:translate-x-1/2 lg:before:translate-x-0 before:top-0 before:h-full before:w-[1px] before:bg-gradient-to-b before:from-blue-500/30 before:via-white/5 before:to-transparent px-2 lg:px-0 lg:pr-12 text-center lg:text-right">
                        ...
                        >
                            ...
                            <div className="hidden lg:block absolute right-1/2 translate-x-1/2 lg:translate-x-0 lg:-right-[43px] top-8 w-3.5 h-3.5 md:w-6 md:h-6 rounded-full bg-slate-950 border-[3px] md:border-4 border-blue-500 flex items-center justify-center z-10" />
                            <div className="flex flex-col lg:flex-row items-center gap-3 md:gap-4 mb-4">
                                <div className="p-2 md:p-3 bg-blue-500/10 rounded-xl md:rounded-2xl text-blue-500 flex-shrink-0">
                                    <FiCompass className="text-lg md:text-2xl group-hover:rotate-45 transition-transform duration-300" />
                                </div>
                                <div className="text-center lg:text-right">
                                    <span className="text-blue-500 font-mono text-[10px] md:text-xs block">CONCEPT</span>
                        ...
                        >
                            ...
                            <div className="flex flex-col lg:flex-row items-center gap-3 md:gap-4 mb-4">
                                ...
                                <div className="text-center lg:text-right">
                                    <span className="text-blue-500 font-mono text-[10px] md:text-xs block">MINDSET</span>
                        ...
                        >
                            ...
                            <div className="space-y-3 flex flex-col items-center lg:items-start">
                                ...
                                <p className="text-slate-400 text-xs md:text-sm leading-relaxed">أن نرفع معايير تنفيذ الأعمال في السوق الرقمي، حتى يصبح الإتقان هو المستوى الطبيعي والأساسي لكل مؤسسة أو فرد نقوم بتمكينه.</p>
                            </div>
                            <div className="space-y-3 border-t md:border-t-0 md:border-r border-white/5 pt-4 md:pt-0 md:pr-6 flex flex-col items-center lg:items-start">
                                ...
                                <p className="text-slate-400 text-xs md:text-sm leading-relaxed">لقد وُجِدنا لرفع معايير تصميم وتنظيم وتنفيذ الأعمال، من خلال موائمة الأفراد والأنظمة الرؤى. نحول الطموح إلى أفعال منضبطة، ونبني شراكات تولد تقدماً حقيقياً ومستداماً.</p>
                            </div>
                        </motion.div>
                        ...
                        <motion.div 
                            ...
                            viewport={{ once: true, margin: "-100px" }}
                            transition={{ duration: 0.5 }}
                            className="relative p-5 md:p-8 rounded-3xl border border-white/5 bg-white/[0.01] backdrop-blur-md shadow-2xl space-y-6 flex flex-col items-center lg:items-start w-full"
                        >
                            {/* تم إضافة hidden lg:block لتختفي الدائرة تماماً في الموبايل */}
                            <div className="hidden lg:block absolute right-1/2 translate-x-1/2 lg:translate-x-0 lg:-right-[43px] top-8 w-3.5 h-3.5 md:w-6 md:h-6 rounded-full bg-slate-950 border-[3px] md:border-4 border-blue-500 flex items-center justify-center z-10" />
                            ...
                            <div className="space-y-4 w-full">
                                {[
                                    ...
                                    <div key={i} className="text-xs md:text-base border-b border-white/[0.03] pb-3 last:border-0 last:pb-0 flex flex-col lg:flex-row lg:items-start justify-center lg:justify-start gap-1 lg:gap-0">
                                        <span className="text-blue-400 font-bold ml-1 flex-shrink-0">{item.t}</span>
                                        <span className="text-slate-400 text-xs md:text-sm">{item.d}</span>
                                    </div>
                                ))}
                            </div>
                        </motion.div>
                        ...
                        >
                            {/* تم إضافة hidden lg:block لتختفي الدائرة تماماً في الموبايل */}
                            <div className="hidden lg:block absolute right-1/2 translate-x-1/2 lg:translate-x-0 lg:-right-[43px] top-8 w-3.5 h-3.5 md:w-6 md:h-6 rounded-full bg-slate-950 border-4 border-blue-500 flex items-center justify-center z-10" />
                            <FiStar className="text-blue-500 text-xl md:text-2xl mb-4" />
                            <h4 className="text-white font-bold mb-3 text-base md:text-lg tracking-tight">Where the real value is created</h4>
                            <p className="text-slate-300 text-xs md:text-base leading-relaxed italic font-light">

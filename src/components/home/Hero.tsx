...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 start-1/2 ltr:-translate-x-1/2 rtl:translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-blue-600/10 blur-[130px] rounded-full pointer-events-none select-none z-0" />
      ...
      <div className="relative z-10 w-full max-w-[1200px] mx-auto px-6 md:px-12 pt-24 md:pt-32 pb-20 md:pb-12 flex flex-col items-center text-center justify-center gap-5 sm:gap-6 md:gap-8 h-full flex-1 max-h-[100dvh]">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 border border-white/[0.2] bg-white/[0.03] backdrop-blur-md px-3.5 py-1.5 rounded-full shrink-0"
        >
          <span className="relative flex h-1.5 w-1.5">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-600 opacity-75"></span>
            <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-blue-600"></span>
          </span>
          <span className="text-white tracking-[0.15em] text-[9px] md:text-xs uppercase">
        ...
        <div className="flex flex-col items-center gap-4 md:gap-6 w-full justify-center">
          ...
          >
            {isAr ? (
              ...
              <>
                {t("titleLine1")} <br />
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-600 font-black">
                  {t("titleLine2")}
                </span>{" "}
                <br />
                {t("titleLine3")}
          ...
          {/* 3. العبارة الفرعية أصبحت مترجمة الآن وتتحول حسب اللغة */}
          <motion.div
          ...
          >
            ...
            <p className="text-[12px] md:text-lg font-medium tracking-tight text-white/60 text-center">
              <span className="italic font-serif font-normal text-white">{t("subTextItalic")}</span>{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-600 font-bold uppercase text-[11px] md:text-sm">
                {t("subTextGradient")}
              </span>
            </p>
            <div className="h-[1px] w-6 md:w-12 bg-white/20 hidden sm:block" />
          ...
          <motion.div
            ...
            className="text-white/40 text-[11px] md:text-sm font-normal max-w-lg border-t border-white/[0.06] pt-3 w-full select-text hidden sm:block"
          >
            {t("supportingText")}
          </motion.div>

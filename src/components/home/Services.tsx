      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-12">
        <div className="max-w-3xl mx-auto mb-16 md:mb-24 flex flex-col items-center text-center space-y-5 transform-gpu">
          ...
          <p className="text-white/80 text-sm md:text-base font-light leading-relaxed max-w-2xl select-text pt-2">
            نقدم مجموعة من الخدمات الرقمية التي تساعد الشركات على تطوير حضورها، تحسين تجربة عملائها، وتنظيم أدواتها الرقمية بشكل أكثر احترافية.
          </p>
        </div>
          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                ...
                {/* الهيدر العلوي: تم إضافة كلاسات ليتمركز في الموبايل */}
                ...
                {/* محاذاة النص والزرار: في المنتصف للموبايل، وتوزيع طبيعي للشاشات الأكبر */}

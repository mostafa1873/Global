...
const reasons = [
  {
    ...
    desc: "كل مشروع يبدأ بفهم واضح للأهداف قبل التنفيذ.",
  },
  {
    id: "02",
    title: "حلول مخصصة",
    desc: "نطور حلولًا تتناسب مع طبيعة كل نشاط تجاري.",
  },
  {
    id: "03",
  ...
  {
    id: "04",
    title: "وضوح في التنفيذ",
    desc: "نعتمد على خطوات عمل واضحة وتنظيم مستمر للمشاريع.",
  },
  {
    id: "05",
    title: "أنظمة قابلة للنمو",
    desc: "نطور حلولًا تساعد الشركات على التوسع بشكل أكثر كفاءة.",
  }
];
      ...
      <div className="relative z-10 w-full max-w-[1300px] mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-16 lg:gap-12">
          ...
          <div className="w-full lg:w-1/2 relative flex flex-col space-y-16 md:space-y-24 md:pr-12 lg:pr-16">
            ...
            <div className="hidden md:block absolute right-0 top-4 bottom-4 w-[1px] bg-gradient-to-b from-white/20 via-white/5 to-transparent pointer-events-none" />

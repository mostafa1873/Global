        ...
        <section className="relative w-full py-10 border-t border-white/10 px-4 sm:px-6 md:px-12 select-none z-10 overflow-hidden" dir="rtl">
            ...
            <div className="relative z-10 w-full max-w-[1000px] mx-auto">
                ...
                >
                    ...
                    <div className="absolute top-0 right-0 w-4 h-[1px] bg-white/20 group-hover:bg-nexus-blue/50 transition-colors duration-500" />
                    <div className="absolute top-0 right-0 h-4 w-[1px] bg-white/20 group-hover:bg-nexus-blue/50 transition-colors duration-500" />
                    <div className="absolute bottom-0 left-0 w-4 h-[1px] bg-white/10 group-hover:bg-nexus-blue/30 transition-colors duration-500" />
                    <div className="absolute bottom-0 left-0 h-4 w-[1px] bg-white/10 group-hover:bg-nexus-blue/30 transition-colors duration-500" />

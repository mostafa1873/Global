    ...
    return (
        <section className="relative w-full py-10 sm:py-10 px-4 bg-transparent overflow-hidden" dir="rtl">
            ...
            <div className="max-w-4xl mx-auto relative z-10 text-center">
                ...
                {/* العنوان - ربط مباشر بفقرة "الناس بتاخدنا بجد" */}
                <motion.h2 
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    className="text-white text-2xl sm:text-3xl md:text-5xl font-black leading-tight tracking-tight mb-12 sm:mb-16"
                >
                    خلي العالم يشوف مشروعك كـ <span className="text-blue-600 italic underline decoration-white/10">براند يُحترم</span>.<br className=" md:block" />
                    جاهز نبدأ رحلة التحول النهاردة؟
                </motion.h2>
                ...
                <p className="mt-10 text-slate-500 text-sm font-light tracking-wide opacity-50">
                    Your Brand Transformation Starts Here — 2026
                </p>
